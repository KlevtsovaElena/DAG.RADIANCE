...
<body>
    ...
    <img style="display: block; width: 100%" src="./img/present/31.png" alt="">
    <img style="display: block; width: 100%" src="./img/present/32.png" alt="">
    <img style="display: block; width: 100%" src="./img/present/33.png" alt="">
    <img style="display: block; width: 100%" src="./img/present/34.png" alt="">
