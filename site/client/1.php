        ...
        <div class="article-container inner_section">
            <div class="article-text">
                ...
                <div class="section-first">
                    <img class="img-section img-sun-in-mountains" src="./img/section1/sun-in-mountains.jpg" alt="">
        ...
        <div class="article-container">
            <div class="article-text">
                ...
                <div class="img-double">
                    <img class="img-section img-smaller" src="./img/section1/green.jpg" alt="">
                    <img class="img-section img-bigger" src="./img/section1/snow.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
