...
<body>
    ...
    <main>
        ...
        <div class="two-buttons plus-one-btn">
            <a href="geography-and-climate.php" class="card-btn card-item__btn btn-big btn-theme">Предыдущая</a>
            <a href="../index.php" class="card-btn card-item__btn btn-big btn-theme">На главную</a>
            <a href="fests-and-traditions.php" class="card-btn card-item__btn btn-big btn-theme">Далее</a>
        </div>
